...
//            }
        ...
        .alert(
            "To do lis \(todoListViewModel.removeTodoCount)개 삭제하시겠습니까?",
        ...
        .onChange(
            ...
            perform: { todo in
                homeViewModel.setTodoCount(todo.count)
            }
        )
    }
}
        ...
        VStack(spacing: 20) {
            HStack {
                ...
                VStack(alignment: .leading, spacing: 5) {
                    Text(todo.title)
                        .font(.system(size: 16))
                        .foregroundColor(todo.selected ? .customIconOn : .customBlack)
