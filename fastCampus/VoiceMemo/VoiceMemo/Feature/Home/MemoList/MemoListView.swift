...
struct MemoListView: View {
    ...
    var body: some View {
            ...
            VStack {
                if !memoListViewModel.memos.isEmpty {
                    CustomNavigationBar(
                        ...
                        rightBtnType: memoListViewModel.navigationBarBightBtnMode
        ...
        .onChange(
            ...
            perform: { memo in
                homeViewModel.setMemoCount(memo.count)
            }
        )
    }
}
...
private struct MemoListContentView: View {
    @EnvironmentObject private var memoListModel: MemoListViewModel
        ...
        VStack{
            ...
            ScrollView(.vertical) {
                VStack(spacing: 0) {
                    ...
                    ForEach(memoListModel.memos, id: \.self) { memo in
