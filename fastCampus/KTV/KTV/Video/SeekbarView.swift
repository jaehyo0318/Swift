...
class SeekbarView: UIView {
    ...
    @IBOutlet weak var playaTimeWidth: NSLayoutConstraint!
    ...
    private func updatePlayedWidth(touch: UITouch) {
        ...
        self.playaTimeWidth.constant = xPosition
    ...
    private func update() {
        ...
        self.playaTimeWidth.constant = self.widthForTime(self.currentPlayTime)
